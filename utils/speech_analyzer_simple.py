# utils/speech_analyzer_simple.py
import re
import nltk
...
class SpeechAnalyzer:
    def __init__(self):
        ...
        # Skip LanguageTool initialization for now
    ...
    def analyze_transcript(self, transcript_data: Dict) -> Dict:
        ...
        try:
            ...
            grammar_analysis = self._analyze_grammar_simple(transcript_text)
    ...
    def _analyze_grammar_simple(self, text: str) -> Dict:
